...
A help to create wds tar files from jpg & txt files can be this script. (json supports still needs to be added - **edit: added json support with --json flag 04-19-2022**) https://github.com/robvanvolt/DALLE-datasets/blob/527e54aeac879bc4da669fa5c5b64c9354890728/utilities/wds_create_shards.py
